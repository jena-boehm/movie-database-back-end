...
app.post('/movies', async(req, res) => {
  try {
    ...
    RETURNING *
    `,
    // use the $ syntax and this array to prevent SQL injection
    [newName, newYear, newOscars, newGenre, newOwnerId]);
...
app.put('/movies/:id', async(req, res) => {
  try {
    ...
    [newName, newYear, newOscars, newGenre, newOwnerId, req.params.id]);
